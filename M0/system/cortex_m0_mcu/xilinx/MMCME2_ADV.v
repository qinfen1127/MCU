// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/rainier/MMCME2_ADV.v,v 1.5 2005/06/17 18:29:09 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
  ...
  always @(posedge pll_locked_tmp1) 
    if (clkinsel_in === 0) begin
       ...
       if (period_avg > pchk_tmp1 || period_avg < pchk_tmp2) begin
         $display("Error : input CLKIN2 period and attribute CLKIN2_PERIOD are not same.");
         $finish;
       end
    end 
    else begin
       ...
       if (period_avg > pchk_tmp1 || period_avg < pchk_tmp2) begin
         $display("Error : input CLKIN1 period and attribute CLKIN1_PERIOD are not same.");
         $finish;
       end
    end 
